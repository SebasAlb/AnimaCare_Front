...
class AppColors {
  ...
  static const Color oldHeader = Color(0xFF3E0B53);
  static const Color oldSecondary = Color(0xFF75C9C8);
  static const Color oldHighlight = Color(0xFFFFA726);

  // 🎨 Nueva Paleta actual
  static const Color background = Color(0xFF4DD0E2); // Fondo general (Celeste claro)
  ...
  static const Color labelBackground = Color(0xFF35919E); // Fondo de label eventos
  ...
  static const Color eventMedicine = Color(0xFFFFA726);     // Medicinas (Amarillo pastel)
  ...
  static const Color markerBorder = Color(0xFFFFD54F); // Resaltado de días cargados (Amarillo dorado pastel)
  static const Color selectedDay = Color(0xFF301B92);  // Día seleccionado (Azul oscuro medio púrpura)

  // 🎨 Botones y acciones
  static const Color formatButtonBackground = Colors.white;
  static const Color formatButtonForeground = Color(0xFF35919E); // Color del texto de botones de formato
